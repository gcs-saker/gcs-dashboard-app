...
import { areStreamDevicesEqual, areStreamSlotsEqual, ensureEditableCctvSlot } from "@dashboard/streaming/dashboardStreamState";
import { DEFAULT_DASHBOARD_STREAMS, type DashboardStreamGeometry, type DashboardStreamSlot } from "@dashboard/streaming/streamTypes";
import type { StreamDeviceOption } from "@dashboard/assets/streamDeviceContracts";
