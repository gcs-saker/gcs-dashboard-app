...
vi.mock("@dashboard/operations/serverStatus", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@dashboard/operations/serverStatus")>();
  return {
    ...actual,
