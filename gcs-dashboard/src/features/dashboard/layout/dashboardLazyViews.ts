...
export const loadTacticalLeafletMap = () => import("@dashboard/map/TacticalLeafletMap");
export const loadEventLogView = () => import("@dashboard/components/EventLogView");
export const loadTimeSyncSettingsView = () => import("@dashboard/components/TimeSyncSettingsView");
