...
| GET | `/media-control/api/v1/streams/{streamId}/publish` | bearer/publisher | `Authorization` | path `streamId` | none | `streamId`, `whipUrl` | browser/mobile publisher 송출 URL 발급 |
