...
def build_commands() -> list[GateCommand]:
    return [
        GateCommand(
            ...
            command=["bash", "scripts/m7_external_nat_webrtc_smoke.sh", "--check"],
        ),
        GateCommand(
        ...
        GateCommand(
            ...
            command=["python3", "scripts/postgis_runtime_smoke.py", "--check"],
        ),
        GateCommand(
            ...
            command=["python3", "scripts/postgis_runtime_smoke.py"],
        ),
    ]
