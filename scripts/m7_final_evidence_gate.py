...
def build_commands() -> list[EvidenceCommand]:
    return [
        ...
        EvidenceCommand(
            ...
            command=["python3", "scripts/m7_performance_benchmark_matrix.py", "--check"],
        ),
        EvidenceCommand(
            ...
            command=[
                "python3",
                "scripts/telemetry_bulk_flush_benchmark.py",
                "--records",
                "1000",
                "--batch-size",
                "100",
        ...
        EvidenceCommand(
            ...
            command=["python3", "scripts/webrtc_ice_smoke.py", "--check"],
        ),
        EvidenceCommand(
            name="grpc_contract",
        ...
        EvidenceCommand(
            ...
            command=["python3", "scripts/ai_overlay_sidecar_smoke.py", "--run"],
        ),
        EvidenceCommand(
        ...
        EvidenceCommand(
            ...
            command=["python3", "scripts/closed_network_static_check.py"],
        ),
        EvidenceCommand(
