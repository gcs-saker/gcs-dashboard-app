...
usage() {
  cat <<'EOF'
Usage:
  scripts/smoke/m7_auth_policy_cutover_smoke.sh [--check|--run]
...
run_check() {
  bash -n "$0"
  grep -q "class AuthController" "${REPO_ROOT}/services/auth-policy/src/main/kotlin/kr/co/a4ai/gcssaker/authpolicy/api/identity/AuthController.kt"
  grep -q "@PostMapping(AuthApiRoutes.SIGNUP)" "${REPO_ROOT}/services/auth-policy/src/main/kotlin/kr/co/a4ai/gcssaker/authpolicy/api/identity/AuthController.kt"
  grep -q "@PostMapping(AuthApiRoutes.LOGIN)" "${REPO_ROOT}/services/auth-policy/src/main/kotlin/kr/co/a4ai/gcssaker/authpolicy/api/identity/AuthController.kt"
  grep -q "const val SIGNUP = \"/signup\"" "${REPO_ROOT}/services/auth-policy/src/main/kotlin/kr/co/a4ai/gcssaker/authpolicy/api/identity/AuthApiRoutes.kt"
  grep -q "const val LOGIN = \"/login\"" "${REPO_ROOT}/services/auth-policy/src/main/kotlin/kr/co/a4ai/gcssaker/authpolicy/api/identity/AuthApiRoutes.kt"
